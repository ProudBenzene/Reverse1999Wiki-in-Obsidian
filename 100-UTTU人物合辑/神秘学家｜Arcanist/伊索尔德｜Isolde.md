...
|                                 洞悉等级                                  |                                                                                 效果                                                                                 |               |                                                  |
| :-------------------------------------------------------------------: | :----------------------------------------------------------------------------------------------------------------------------------------------------------------: | ------------- | ------------------------------------------------ |
| ![洞悉一\|50](000-箱的构成/templates/assets/UTTU人物合辑.assets/图标%20洞悉Ⅰ.png)洞悉一 | 进入战斗时，进入**[序曲]**[^1]状态，对敌方全体施加3层**[燃烧]**[^3]；回合结束时，根据敌方**[燃烧]**[^3]层数最高的角色结算失去的**[燃烧]**[^3]层数获得等量层数**[热度]**[^4]；**[热度]****[^4]达到15时，**[序曲]**[^1]进阶为**[幕间曲]**[^5]状态 |               |                                                  |
|                    ![洞悉二\|50](000-箱的构成/templat 洞悉一                    |        进入战斗时，进入**[序曲]**[^1]状态，对敌方全体施加3层**[燃烧]**[^3]；回合结束时，根据敌方**[燃烧]**层数最高的角色结算失去的**[燃烧]**层数获得等量层数**[热度]**[^4]；**[热度]**达到15时，**[序曲]**[^1]进阶为**[幕间曲]**[^5]状态        | 20洞悉Ⅲ.png)洞悉三 | **[热度]**[^4]达到40时，**[幕间曲]**[^5]进阶为**[终曲]**[^6]状态 |

 洞悉二 |                                                                  进入战斗时，*攻击*提升**5%**                                                                  |   |                             技能                             |                   文化                   |
> | :--: | :----------------------------------------------------------: | :----------------------------------------------------------: | :--------------------------------------: |
> | ✦✧✧  | ![减益](000-箱的构成/templates/assets/UTTU人物合辑.assets/Debuff.png)<b><font color="#7B5E91">减益</font></b> | 群体攻击，对2名敌人造成**150%**现实创伤；命中时赋予目标2层**[燃烧]**[^3]；处于**[幕间曲]**[^5]时，本次攻击穿透率提升30%；处于**[终曲]**[^6]时，本次攻击穿透率提升**50%** |               步音与歌声。               |
> | ✦✦✧  | ![减益](000-箱的构成/templates/assets/UTTU人物合辑.assets/Debuff.png)<b><font color="#7B5E91">减益</font></b> | 群体攻击，对2名敌人造成**225%**现实创伤；命中时赋予目标2层**[燃烧]**[^3]；处于**[幕间曲]**[^5]时，本次攻击穿透率提升**30%**；处于**[终曲]**[^6]时，本次攻击穿透率提升**50%** |        步音与歌声，在舞台上兜转。        |
> | ✦✦✦  | ![减益](000-箱的构成/templates/assets/UTTU人物合辑.assets/Debuff.png)<b><font color="#7B5E91">减益</font></b> | 群体攻击，对2名敌人造成**300%**现实创伤；命中时赋予目标2层**[燃烧]**[^3]；处于**[幕间曲]**[^5]时，本次攻击穿透率提升**30%**；处于**[终曲]**[^6]时，本次攻击穿透率提升**50%** | 步音与歌声，在舞台上兜转，台下无处落脚。 |
> 
...
> | 技能                                                         |      文化      |
> | ------------------------------------------------------------ | :------------: |
> | 群体削弱，赋予敌方全体5层**[燃烧]**[^3]，额外赋予主目标5层**[燃烧]**[^3]，同时使己方全体获得1层**[激昂]**；之后释放**[间奏曲]**[^7]追击目标，且至终的仪式每使主目标**[燃烧]**[^3]溢出1层，则本次**[间奏曲]**[^7]*术法威力*提升**15%** | 此刻我宽恕您！ |
> 
...
| 塑造等级 |                           塑造效果                           |
| :------: | :----------------------------------------------------------: |
|   Lv.1   | 【七重纱】**[间奏曲]**[^7]目标每层**[燃烧]**[^3]所额外造成的现实创伤提高到**13%** |
|   Lv.2   | 【七重纱】**[序曲]**[^1]进阶为**[幕间曲]**[^5]所需的**[热度]****[^4]降低到**10**，**[幕间曲]**[^5]进阶为**[终曲]**[^6]所需的**[热度]****[^4]降低到**30** |
|   Lv.3   | 【七重纱】**[间奏曲]**[^7]目标每层**[燃烧]**[^3]所额外造成的现实创伤提高到**16%** |
|   Lv.4   | 【盘旋的哼唱】在咒语1/2/3阶时，造成的现实创伤提升至**200/300/400%** |
|   Lv.5   | 【七重纱】**[间奏曲]**[^7]目标每层**[燃烧]**[^3]所额外造成的现实创伤提高到**20%** |
...
[^4]: ==热度==：**［燃烧］**[^3]层数结算等量转化
[^5]: ==幕间曲==：回合开始时使己方全体获得3层**［预燃］**[^2]；敌方最高**［燃烧］**[^3]层数大于等于**6**层时，释放**［间奏曲］**[^7]（不可驱散）
[^6]: ==终曲==：回合开始时使己方全体获得3层**［预燃］**[^2]、1层**［爆发力］**；敌方最高**［燃烧］**[^3]层数大于等于6层时，释放**［间奏曲］**[^7]，且本次攻击术法威力提高15%（不可驱散）
