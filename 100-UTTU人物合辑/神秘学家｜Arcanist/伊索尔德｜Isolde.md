...
|                                 洞悉等级                                  |                                                效果                                                |
| :-------------------------------------------------------------------: | :----------------------------------------------------------------------------------------------: |
| ![洞悉一\|50](000-箱的构成/templates/assets/UTTU人物合辑.assets/图标%20洞悉Ⅰ.png)洞悉一 | 进入战斗时，进入[序曲]状态，对敌方全体施加3层[燃烧]；回合结束时，根据敌方[燃烧]层数最高的角色结算失去的[燃烧]层数获得等量层数[热度]；[热度]达到15时，[序曲]进阶为[幕间曲]状态 |
