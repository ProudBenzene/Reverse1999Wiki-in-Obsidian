...
|                           洞悉等级                           |                          效果                           |
| :----------------------------------------------------------: | :-----------------------------------------------------: |
| ![洞悉一\|50](../../000-箱的构造/templates/assets/UTTU人物合辑.assets/图标%20洞悉Ⅰ.png)洞悉一 |     进入战斗时，自身进入**[祷言]**状态(最多触发1次)     |
| ![洞悉二\|50](../../000-箱的构造/templates/assets/UTTU人物合辑.assets/图标%20洞悉Ⅱ.png)洞悉二 |            进入战斗时，*造成伤害*提升**8%**             |
| ![洞悉三\|50](../../000-箱的构造/templates/assets/UTTU人物合辑.assets/图标%20洞悉Ⅲ.png)洞悉三 | 每当己方有**[祷言]**消失时，回复自身攻击\***50%**的生命 |
...
> |                             技能                             |                     文化                     |
> | :----------------------------------------------------------: | :------------------------------------------: |
> | 群体增强，赋予其他友方1层**[祷言]**，且造成伤害提升**30%**，持续3回合；若目标已拥有**[祷言]**，则立刻回复*使用者攻击*\***100%**生命 | 墓碑们絮絮叨叨，她只是聆听，并记录未竟之事。 |
> 
...
[^1]: ==特殊== 受到致命攻击时不会退场，并回复使用者攻击*100%生命（生效后消失，不可叠加）