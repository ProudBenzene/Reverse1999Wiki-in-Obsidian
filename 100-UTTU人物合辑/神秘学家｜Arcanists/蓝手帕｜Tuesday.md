...
|                           洞悉等级                           |                             效果                             |
| :----------------------------------------------------------: | :----------------------------------------------------------: |
| ![洞悉一\|50](../../000-箱的构造/assets/UTTU人物合辑.assets/图标%20洞悉Ⅰ.png)洞悉一 | 进入战斗时，获得**[恐惧襁褓]**[^1]<br/>进入战斗时，使自身造成*本源创伤*提升**15%** |
| ![洞悉二\|50](../../000-箱的构造/assets/UTTU人物合辑.assets/图标%20洞悉Ⅱ.png)洞悉二 |                 进入战斗时，*攻击*提升**5%**                 |
| ![洞悉三\|50](../../000-箱的构造/assets/UTTU人物合辑.assets/图标%20洞悉Ⅲ.png)洞悉三 | 进入战斗时，获得**[客房服务]**[^2]<br/>进入战斗时，自身激情+**2**（最多触发**1**次） |

## 神秘术

> [!skill]- “怯”与“喜”
> ![“怯”与“喜” 一阶|100](assets/蓝手帕｜Tuesday.assets/神秘术%20“怯”与“喜”1%201.png)
> 
> | 等级 |                             类型                             |                             技能                             |                    文化                    |
> | :--: | :----------------------------------------------------------: | :----------------------------------------------------------: | :----------------------------------------: |
> | ✦✧✧  | ![减益](../../000-箱的构造/assets/UTTU人物合辑.assets/Debuff.png)<b><font color="#7B5E91">减益</font></b> | 单体攻击，造成**130%**精神创伤，使其陷入**2**个**[中毒]**[^3]2回合，每回合结束时，对其造成使用者攻击\***20%**的*本源创伤*，之后随机使另一个敌方目标陷入**1**个相同的**[中毒]**[^3]状态，重复**2**次（若没有可用的敌方目标，则不再触发） |              一颗恐惧的种子。              |
> | ✦✦✧  | ![减益](../../000-箱的构造/assets/UTTU人物合辑.assets/Debuff.png)<b><font color="#7B5E91">减益</font></b> | 单体攻击，造成**230%**精神创伤，使其陷入**2**个**[中毒]**[^3]2回合，每回合结束时，对其造成使用者攻击\***20%**的*本源创伤*，之后随机使另一个敌方目标陷入**1**个相同的**[中毒]**[^3]状态，重复**3**次（若没有可用的敌方目标，则不再触发） |        一颗恐惧的种子，落入了沃壤。        |
> | ✦✦✦  | ![减益](../../000-箱的构造/assets/UTTU人物合辑.assets/Debuff.png)<b><font color="#7B5E91">减益</font></b> | 单体攻击，造成**455%**精神创伤，使其陷入**2**个**[中毒]**[^3]2回合，每回合结束时，对其造成使用者攻击\***20%**的*本源创伤*，之后随机使另一个敌方目标陷入**1**个相同的**[中毒]**[^3]状态，重复**4**次（若没有可用的敌方目标，则不再触发） | 一颗恐惧的种子，生根、抽芽，被满足地端详。 |
> 

> [!skill]- 累日的拍抚
> ![累日的拍抚 一阶|100](assets/蓝手帕｜Tuesday.assets/神秘术%20累日的拍抚1%201.png)
> 
> | 等级 |                             类型                             |                             技能                             |                   文化                   |
> | :--: | :----------------------------------------------------------: | :----------------------------------------------------------: | :--------------------------------------: |
> | ✦✧✧  | ![减益](../../000-箱的构造/assets/UTTU人物合辑.assets/Debuff.png)<b><font color="#7B5E91">减益</font></b> | 群体削弱，使敌方全体受到*本源创伤*提升**15%**，*抗暴率*降低**15%**，持续**2**回合；若目标陷入**[中毒]**[^3]状态，则*抗暴率*减少效果提升至**20%** |              婴孩所需要的。              |
> | ✦✦✧  | ![减益](../../000-箱的构造/assets/UTTU人物合辑.assets/Debuff.png)<b><font color="#7B5E91">减益</font></b> | 群体削弱，使敌方全体受到*本源创伤*提升**25%**，*抗暴率*降低**15%**，持续**2**回合；若目标陷入**[中毒]**[^3]状态，则*抗暴率*减少效果提升至**20%** |           婴孩成人后所需要的。           |
> | ✦✦✦  | ![减益](../../000-箱的构造/assets/UTTU人物合辑.assets/Debuff.png)<b><font color="#7B5E91">减益</font></b> | 群体削弱，使敌方全体受到*本源创伤*提升**35%**，*抗暴率*降低**15%**，持续**2**回合；若目标陷入**[中毒]**[^3]状态，则*抗暴率*减少效果提升至**20%** | 每个人所需要的。她已将这些需要一一应答。 |
> 

> [!skill]- 请进、请进
> ![请进、请进|100](assets/蓝手帕｜Tuesday.assets/至终的仪式%20请进、请进%201.png)
> 
> |                             技能                             |                    文化                    |
> | :----------------------------------------------------------: | :----------------------------------------: |
> | 群体攻击，对敌方全体造成**225%**精神创伤，命中时使其陷入**1**个**[中毒]**[^3]2回合，每回合结束时，对其造成使用者攻击\***20%**的本源创伤；之后额外造成蓝手帕攻击\*目标**[中毒]**[^3]个数\***30%**的*本源创伤*，且该*本源创伤*可以暴击；同时布设术阵**[惊惧故事会]**[^4]3回合 | 您瞧，恐惧的最深处，只是紧闭的空房间而已。 |
> 
...
| 塑造等级 |                           塑造效果                           |
| :------: | :----------------------------------------------------------: |
|   Lv.1   | 【请进、请进】附加的**[中毒]**[^3]个数提升至**2**，额外造成攻击\*目标**[中毒]**[^3]个数的*本源创伤*提升至**50%** |
|   Lv.2   | 【累日的拍抚】在咒语1/2/3阶时，造成*本源创伤*提升的效果提升至**30%**/**40%**/**50%**，*抗暴率*降低的效果提升至**25%**，若目标陷入**[中毒]**[^3]状态，则*抗暴率*减少效果提升至**30％** |
|   Lv.3   | 【请进、请进】附加的**[中毒]**[^3]个数提升至3，额外造成攻击\*目标**[中毒]**[^3]个数的*本源创伤*提升至**70%** |
|   Lv.4   |    【为您效劳】附加的提升自身*本源创伤*的效果变为**35%**     |
|   Lv.5   | 【“怯”与“喜”】在咒语1/2/3阶时，造成的精神创伤提升至**210%**/**310%**/**535%**，随机使另一个敌方目标陷入**中毒的次数**提升至**3**/**4**/**5** |
...
title: 
color: 
> [!culture]+ 细棉布头巾｜Maid's Bandeau
> ![](assets/蓝手帕｜Tuesday.assets/单品%20蓝手帕%2001.png)
> ![利齿子儿|inlL](../../000-箱的构造/assets/UTTU人物合辑.assets/货币%20利齿子儿.png)**0.7**
> ---
> 旅馆侍者常见的棉布头巾，质地柔软，因多次水洗略有褪色。“旅馆主夫妇的女儿”比“旅馆的女主人”更加方便。柔软与循规蹈矩是绝佳的基底，能够令纯白之下的恐怖无限放大。她已深谙此道。

> [!culture]+ 旅馆钥匙组｜Motel Keys
> ![](assets/蓝手帕｜Tuesday.assets/单品%20蓝手帕%2002.png)
> ![利齿子儿|inlL](../../000-箱的构造/assets/UTTU人物合辑.assets/货币%20利齿子儿.png)**0.15**
> ---
> 一串叮当作响的钥匙，同每一位女主人腰间的钥匙别无二致。她将钥匙对应的每一扇门谙熟于心，了解程度甚于母亲之于孩子。有时，锁眼的形状与位置会发生变化，如同某种孩童的恶作剧，但这对母亲来说无关紧要。

> [!culture]+ “襁褓”｜"A Baby"
> ![](assets/蓝手帕｜Tuesday.assets/单品%20蓝手帕%2003.png)
> **无估值**
> ---
> 白色棉布包裹的襁褓，绝大多数时间沉默，偶尔扭动或啼哭。成为一名母亲是简单的，她为“它”带来爱、哺育与掌控，因此，她当然是一名合格的母亲——受访者微笑着表示道。
````
...
而旅馆需要一位主人，当然，当然。
tab:《南部平原之声》剪报｜Southern Voices Clippings
...
|        帽檐与发鬓         |                                                                                                                   只有头，或没有头，这样的形象，一晚只能出现一次，多了就会让客人习惯，连我也会感到乏味。<br>Only the head, or no head at all. And only once per night; don't want the guests to get too accustomed to the horror, and it'd get altogether tedious.                                                                                                                    |
...
|        择选高阶咒语        |                                                                                                                                                                                              哦，瞧您的肩膀上……<br>What's that up on your shoulder …?                                                                                                                                                                                              |
