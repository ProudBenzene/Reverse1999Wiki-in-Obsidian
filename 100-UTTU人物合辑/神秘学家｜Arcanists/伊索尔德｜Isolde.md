...
|                           洞悉等级                           |                             效果                             |
| :----------------------------------------------------------: | :----------------------------------------------------------: |
| ![洞悉一\|50](../../000-箱的构造/templates/assets/UTTU人物合辑.assets/图标%20洞悉Ⅰ.png)洞悉一 | 进入战斗时，进入**[序曲]**[^1]状态，对敌方全体施加3层**[燃烧]**[^2]；回合结束时，根据敌方**[燃烧]**[^2]层数最高的角色结算失去的**[燃烧]**[^2]层数获得等量层数**[热度]**[^3]；**[热度]**[^3]达到15时，**[序曲]**[^1]进阶为**[幕间曲]**[^4]状态 |
| ![洞悉二\|50](../../000-箱的构造/templates/assets/UTTU人物合辑.assets/图标%20洞悉Ⅱ.png)洞悉二 |                 进入战斗时，*攻击*提升**5%**                 |
| ![洞悉三\|50](../../000-箱的构造/templates/assets/UTTU人物合辑.assets/图标%20洞悉Ⅲ.png) 洞悉三 | **[热度]**[^3]达到 40 时，**[幕间曲]**[^4]进阶为**[终曲]**[^5]状态 |
...
> | 等级 |                             类型                             |                             技能                             |                 文化                 |
> | :--: | :----------------------------------------------------------: | :----------------------------------------------------------: | :----------------------------------: |
> | ✦✧✧  | ![减益](../../000-箱的构造/templates/assets/UTTU人物合辑.assets/Debuff.png)<b><font color="#7B5E91">减益</font></b> | 群体攻击，对2名敌人造成**150%**现实创伤；命中时赋予目标2层**[燃烧]**[^2]；处于**[幕间曲]**[^4]时，本次攻击穿透率提升30%；处于**[终曲]**[^5]时，本次攻击穿透率提升**50%** |               步音与歌声。               |
> | ✦✦✧  | ![减益](../../000-箱的构造/templates/assets/UTTU人物合辑.assets/Debuff.png)<b><font color="#7B5E91">减益</font></b> | 群体攻击，对2名敌人造成**225%**现实创伤；命中时赋予目标2层**[燃烧]**[^2]；处于**[幕间曲]**[^4]时，本次攻击穿透率提升**30%**；处于**[终曲]**[^5]时，本次攻击穿透率提升**50%** |        步音与歌声，在舞台上兜转。        |
> | ✦✦✦  | ![减益](../../000-箱的构造/templates/assets/UTTU人物合辑.assets/Debuff.png)<b><font color="#7B5E91">减益</font></b> | 群体攻击，对2名敌人造成**300%**现实创伤；命中时赋予目标2层**[燃烧]**[^2]；处于**[幕间曲]**[^4]时，本次攻击穿透率提升**30%**；处于**[终曲]**[^5]时，本次攻击穿透率提升**50%** | 步音与歌声，在舞台上兜转，台下无处落脚。 |
...
> | 等级 |                             类型                             |                             技能                             |                 文化                 |
> | :--: | :----------------------------------------------------------: | :----------------------------------------------------------: | :----------------------------------: |
> | ✦✧✧  | ![减益](../../000-箱的构造/templates/assets/UTTU人物合辑.assets/Debuff.png)<b><font color="#7B5E91">减益</font></b> | 群体削弱，使敌方全体*暴击防御*降低**25%**，*现实防御*降低**15%**，持续2回合；若目标陷于**[燃烧]**[^2]状态，则*现实防御*减少效果提升至**20%** |               一支舞。               |
> | ✦✦✧  | ![减益](../../000-箱的构造/templates/assets/UTTU人物合辑.assets/Debuff.png)<b><font color="#7B5E91">减益</font></b> | 群体削弱，使敌方全体*暴击防御*降低**35%**，*现实防御*降低**15%**，持续2回合；若目标陷于**[燃烧]**[^2]状态，则*现实防御*减少效果提升至**20%** |        一支舞，作为我的低诉。        |
> | ✦✦✦  | ![减益](../../000-箱的构造/templates/assets/UTTU人物合辑.assets/Debuff.png)<b><font color="#7B5E91">减益</font></b> | 群体削弱，使敌方全体*暴击防御*降低**50%**，*现实防御*降低**15%**，持续2回合；若目标陷于**[燃烧]**[^2]状态，则*现实防御*减少效果提升至**20%** | 一支舞，作为我的低诉，人们偶有耳闻。 |
> 
