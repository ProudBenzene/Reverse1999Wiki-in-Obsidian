...
|                                    洞悉等级                                     |                                                                                          效果                                                                                           |
| :-------------------------------------------------------------------------: | :-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: |
| ![洞悉一\|50](../../000-箱的构造/templates/assets/UTTU人物合辑.assets/图标%20洞悉Ⅰ.png)洞悉一 | 攻击时*攻击力*提升，提升数值等同于自身**[燃烧]**[^1]层数\***0.5%**，同时使自身**[燃烧]**[^1]结算造成伤害（本次结算不扣除层数）；每次攻击成功施加**[燃烧]**[^1]后，使自身获得相同层数的**[燃烧]**[^1]；自身受到的**[燃烧]**[^1]结算伤害降低**50%**，且不会因该结算效果使自身*生命*低于**15%** |
| ![洞悉二\|50](../../000-箱的构造/templates/assets/UTTU人物合辑.assets/图标%20洞悉Ⅱ.png)洞悉二 |                                                                                 进入战斗时，*造成伤害*提升**8%**                                                                                  |
| ![洞悉三\|50](../../000-箱的构造/templates/assets/UTTU人物合辑.assets/图标%20洞悉Ⅲ.png)洞悉三 |         自身携带**[燃烧]**[^1]上限提升至**35**层，同时处于**[燃烧]**[^1]状态时免疫**[冰冻]**[^2] **[寒冷]**[^3]；回合开始时，若自身*生命*低于**50%**，驱散自身除**[燃烧]**[^1]外的**[属性削弱]** **[状态异常]**后，使自身*暴击率*提升**20%**，持续**1**回合          |
